...
public class LoginPage  {
	...
	public void enterUsername(String UserName) {
		...
		gMob.sendKeysOnTextBox(usernameTxtBox, UserName, "Username Entered Successfully");
	}

	public void enterPassword(String Password) {
		gMob.clickElement(passwordTxtBox, "Click On Password Textbox");
		gMob.sendKeysOnTextBox(passwordTxtBox, Password, "Password Entered Successfully");
	}
